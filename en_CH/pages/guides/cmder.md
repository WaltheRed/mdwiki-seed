...
The resulting conemu.xml looks like this:

```xml
<?xml version="1.0" encoding="utf-8"?>
<key name="Software">
	<key name="ConEmu">
		<key name=".Vanilla" modified="2018-10-25 10:26:30" build="180626">
			...
			<value name="CursorTypeActive" type="dword" data="000232c3"/>
			...
			<value name="StartTasksName" type="string" data="{WSL::bash}"/>
			...
			<value name="ConWnd X" type="long" data="1221"/>
			<value name="ConWnd Y" type="long" data="88"/>
			...
			<value name="DisableAllFlashing" type="hex" data="01"/>
			...
			<key name="Tasks" modified="2018-02-22 06:02:12" build="171109">
				...
				<key name="Task9" modified="2018-10-25 10:26:30" build="180626">
					...
					<value name="Cmd1" type="string" data='set "PATH=%ConEmuBaseDirShort%\wsl;%PATH%" &amp; %ConEmuBaseDirShort%\conemu-cyg-64.exe --wsl -C~ -cur_console:pm:/mnt'/>
					<value name="Active" type="long" data="0"/>
					<value name="Count" type="long" data="1"/>
				</key>
			</key>
			...
			<key name="HotKeys" modified="2018-10-25 10:26:30" build="180626">
				<value name="KeyMacroVersion" type="hex" data="02"/>
				<value name="Multi.Modifier" type="dword" data="00000011"/>
				<value name="Multi.ArrowsModifier" type="dword" data="0000005b"/>
				<value name="MinimizeRestore" type="dword" data="000011c0"/>
			...
			<value name="LastMonitor" type="string" data="102,0,2560,1440"/>
